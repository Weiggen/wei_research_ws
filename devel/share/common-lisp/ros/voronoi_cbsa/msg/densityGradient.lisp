...
(cl:defmethod cl:initialize-instance :after ((m <densityGradient>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'densityGradient)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name voronoi_cbsa-msg:<densityGradient> is deprecated: use voronoi_cbsa-msg:densityGradient instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <densityGradient>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voronoi_cbsa-msg:header-val is deprecated.  Use voronoi_cbsa-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'gradient_x-val :lambda-list '(m))
(cl:defmethod gradient_x-val ((m <densityGradient>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voronoi_cbsa-msg:gradient_x-val is deprecated.  Use voronoi_cbsa-msg:gradient_x instead.")
  (gradient_x m))

(cl:ensure-generic-function 'gradient_y-val :lambda-list '(m))
(cl:defmethod gradient_y-val ((m <densityGradient>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voronoi_cbsa-msg:gradient_y-val is deprecated.  Use voronoi_cbsa-msg:gradient_y instead.")
  (gradient_y m))

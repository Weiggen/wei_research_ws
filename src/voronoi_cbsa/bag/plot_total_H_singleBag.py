...
def plot_data(timestamps, h1_data, h2_data, h3_data, H_data):
    ...
    plt.ylabel('Value')
    plt.title('Utility of each UAV & Total Utility of Current Simulation')
    plt.legend()
    plt.grid(True)
...
def main():
    ...
    bag_file = '/home/ncrl/wei_research_ws/src/voronoi_cbsa/bag/Wei_dynamicExp_CstCov3_trimmed.bag'

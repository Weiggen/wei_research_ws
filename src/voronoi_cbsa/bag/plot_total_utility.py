...
def main():
    # 替換為您的兩個rosbag文件路徑
    bag_file1 = '/home/ncrl/wei_research_ws/src/voronoi_cbsa/bag/Wei_dynamicExp_CstCov888_trimmed.bag'
    bag_file2 = '/home/ncrl/wei_research_ws/src/voronoi_cbsa/bag/Wei_dynamicExp_TVCov888_trimmed.bag'
